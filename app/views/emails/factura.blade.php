...
<body style="font-family: sans-serif; font-size: 18px; font-style: italic; background: #fff url('http://carioca.craftersama.me/assets/images/bg.png') repeat top center fixed; margin: 0; color: #333;"> 
	...
	<div style="padding: 0 1em; background-color: #fff;">
		...
		<div style="width: 70%; float: left;">
	        <span style="font-weight:bold;">Deposita o has una transferencia a la siguiente Cuenta:</span>
	        <br><br>
	        <span><strong style="color:#060;">Banesco Banco Universal</strong><br>
	        <strong>Cuenta Corriente No.</strong> 0134-0079-26-0791134545<br>
	        <strong>A Nombre de:</strong> Inversiones Medina Molero<br>
	        <strong>RIF No.</strong> J406047910</span>
	    </div>
