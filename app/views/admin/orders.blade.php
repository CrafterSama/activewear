						...
						@foreach ($items as $item)
							<tr class="text-center">
								...
								<td data-title="Acciones" class="text-center">
									...
									<a href="/admin/pedidos/quitar/{{ $item->id }}" class="btn btn-danger btn-xs white"  data-toggle="tooltip" data-placement="top" title="Cancelar Pedido" onclick="return confirm('¿Esta seguro que desea cancelar este pedido?');"><i class="fa fa-trash-o fa-lg"></i></a>
