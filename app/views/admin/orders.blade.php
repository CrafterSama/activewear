						...
						@foreach ($items as $item)
							<tr class="text-center">
								...
								<td data-title="Acciones" class="text-center">
									<a href="/admin/pedidos/aprobar/{{ $item->factura->id }}" class="btn btn-success btn-xs white"  data-toggle="tooltip" data-placement="top" title="Aprobar y Entregar"><i class="fa fa-check fa-lg" onclick="return confirm('¿Esta seguro que ya realizo el pago para aprobar este pedido?');"></i></a>
									<a href="/admin/pedidos/quitar/{{ $item->id }}" class="btn btn-danger btn-xs white"  data-toggle="tooltip" data-placement="top" title="Quitar Producto" onclick="return confirm('¿Esta seguro que desea quitar este producto?');"><i class="fa fa-trash-o fa-lg"></i></a>
