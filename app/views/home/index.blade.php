...
<div class="buttons col-md-8 col-xs-12">
    <div class="img-1 col-xs-6 col-md-6">
        <img class="raw products col-md-12" src="/../assets/images/home_productos.png" alt="productos" width="120%">
    ...
    <div class="img-2 col-xs-6 col-md-6">
        <img class="raw carrito col-md-12" src="/../assets/images/home_carrito.png" alt="carrito" width="120%">
...
<div class="col-md-4 social-buttons">
    <div class="col-md-12">
        ...
        <div class="text-box carioca_color2 row">
            <div class="col-md-12">
