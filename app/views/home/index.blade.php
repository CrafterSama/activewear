...
<div class="buttons col-md-8 col-xs-12">
    <div class="img-1 col-xs-6 col-md-6">
        <img class="raw products" src="/../assets/images/home_productos.png" alt="productos" width="120%">
    ...
    <div class="img-2 col-xs-6 col-md-6">
        <img class="raw carrito" src="/../assets/images/home_carrito.png" alt="carrito" width="120%">
