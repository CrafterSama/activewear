						...
						@foreach ($users as $user)
							<tr>
								...
								<td data-title="Acciones" class="text-center">
									...
									<a href="/admin/usuarios/{{ $user->id }}/password" class="btn btn-danger btn-xs btn-delete" data-id="{{ $user->id }}" data-toggle="tooltip" data-placement="top" title="Borrar Registro" onclick="return confirm('¿Esta seguro que desea borrar este Registro?');"><i class="fa fa-key-o fa-lg"></i></a>
								</td>
							</tr>
		    			@endforeach							
					</tbody>
